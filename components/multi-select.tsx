      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              // Container style
              "flex w-full p-2 rounded-md border border-gray-300 min-h-10 h-auto items-center justify-between bg-white hover:bg-gray-50 focus:border-[#0D99FF] focus:ring-[#0D99FF] focus:outline-none transition-colors",
              className
            )}
          >
                    ...
                    return (
                      <Badge
                        ...
                        className={cn(
                          ...
                          // Badge style
                          "bg-gray-200 text-gray-700 border border-gray-300 p-1 rounded-md"
                        )}
