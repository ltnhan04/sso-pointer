...
export default function PersonalInformationPage() {
  ...
  return (
    <div className="w-full h-screen overflow-auto">
      ...
      <div
        id="Content"
        className="mt-[125px] max-w-[1300px] lg:mt-[100px] lg:ml-[320px] mx-auto p-8 border"
      >
        <div id="Information-Detail">
          <div
            id="Avatar"
            className="grid grid-cols-[1fr_80px] lg:grid-cols-[1fr_80px] border-b-[1px] py-6 "
          >
            ...
            <div className="lg:w-fit flex justify-center items-center">
              <Image
                ...
                width={60}
                height={60}
                className="border-[1px] object-cover rounded-full"
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              <div className="border-[1px] px-6 py-8 bg-white rounded-[4px] space-y-[40px] w-[450px] relative">
                ...
                <div
                  className=" absolute top-[-10px] right-[30px] cursor-pointer transition-all duration-300"
                  onClick={handleClick}
                >
                  ...
                  <div className="space-y-[5px]">
                    <div className="space-y-[10px] h-[70px]">
                      <input
                        ...
                        } focus:border-black  py-2 outline-none`}
                    ...
                    <div>
                      <button
                        type="submit"
                        className="bg-[#0094FF] w-full text-white p-2 rounded-[4px] active:opacity-60 transition-opacity duration-300"
                      >
                        Reset password
                      </button>
                    </div>
